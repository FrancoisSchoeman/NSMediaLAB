        ...
        <AnimatedCard key={index}>
          ...
          <ul className="list-disc ml-6">
            {price.features.map((feature: string, index: number) => (
              <li
                key={index}
                className="max-w-[40ch] sm:max-w-[900px] text-neutral-600 py-1"
              >
                {feature}
              </li>
            ))}
          </ul>
          <p className="max-w-[40ch] sm:max-w-[900px] text-neutral-600 pt-1">
            *{price.extra}
          </p>
          <p className="max-w-[40ch] sm:max-w-[900px] text-neutral-600 pb-1">
